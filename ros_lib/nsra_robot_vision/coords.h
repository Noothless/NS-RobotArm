#ifndef _ROS_SERVICE_coords_h
#define _ROS_SERVICE_coords_h
#include <stdint.h>
#include <string.h>
#include <stdlib.h>
#include "ros/msg.h"

namespace nsra_robot_vision
{

static const char COORDS[] = "nsra_robot_vision/coords";

  class coordsRequest : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return COORDS; };
    virtual const char * getMD5() override { return "0d3772b8a5da1299e56c0ae15e8afe56"; };

  };

  class coordsResponse : public ros::Msg
  {
    public:
